...
import (
	...
	"github.com/appvia/eks-operator/pkg/apis"
	"github.com/appvia/eks-operator/pkg/controller"
	"github.com/appvia/eks-operator/version"
...
func main() {
	...
	err = leader.Become(ctx, "eks-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
