...
// Reconcile reads that state of the cluster for a EKSCluster object and makes changes based on the state read
// and what is in the EKSCluster.Spec
...
func (r *ReconcileEKSCluster) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &awsv1alpha1.EKSCluster{}
	...
	// Set EKSCluster instance as the owner and controller
...
func newPodForCR(cr *awsv1alpha1.EKSCluster) *corev1.Pod {
