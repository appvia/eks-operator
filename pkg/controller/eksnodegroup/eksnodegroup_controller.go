...
// Reconcile reads that state of the cluster for a EKSNodeGroup object and makes changes based on the state read
// and what is in the EKSNodeGroup.Spec
...
func (r *ReconcileEKSNodeGroup) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &awsv1alpha1.EKSNodeGroup{}
	...
	// Set EKSNodeGroup instance as the owner and controller
...
func newPodForCR(cr *awsv1alpha1.EKSNodeGroup) *corev1.Pod {
